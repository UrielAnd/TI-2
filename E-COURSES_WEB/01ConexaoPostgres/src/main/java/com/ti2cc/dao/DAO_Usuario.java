...
public class DAO_Usuario {
	...
	public boolean conectar() {
		...
		String serverName = "ecurses.postgres.database.azure.com";
		String mydatabase = "ecurses";
		int porta = 5432;
		String url = "jdbc:postgresql://" + serverName + ":" + porta +"/" + mydatabase;
		String username = "ti2cc@ecurses";
		String password = "Thewords1000";
	...
	public boolean inserirUsuario(Usuario usuario) {
		...
		try {  
			...
			st.executeUpdate("INSERT INTO usuario (codigo, email, senha, sexo) "
					       + "VALUES ("+usuario.getCodigo()+ ", '" + usuario.getemail() + "', '"  
			...
			ResultSet rs = st.executeQuery("SELECT * FROM usuario");		
	         if(rs.next()){
	             ...
	             for(int i = 0; rs.next(); i++) {
	                usuarios[i] = new Usuario(rs.getInt("codigo"), rs.getString("email"), 
